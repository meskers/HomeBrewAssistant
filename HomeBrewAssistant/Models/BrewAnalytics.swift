...
class BrewAnalytics: ObservableObject {
    ...
    init() {
        ...
        // CLEAN APP STORE EXPERIENCE: NEVER load mock data
        // New users should start with completely empty analytics
        // Mock data completely disabled for App Store release
